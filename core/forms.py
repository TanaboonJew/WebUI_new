...
from .models import UserFile, AIModel, DockerContainer
from django.core.validators import FileExtensionValidator

class DockerfileUploadForm(forms.ModelForm):
    class Meta:
        ...
        help_texts = {
            'dockerfile': 'Upload your Dockerfile to build a custom container'
        }
...
class AIModelForm(forms.ModelForm):
    class Meta:
        ...
        help_texts = {
            'model_file': 'Supported formats: .h5 (Keras/TF), .pt (PyTorch), .onnx',
    ...
    def clean_model_file(self):
        ...
        if model_file:
            ...
            if model_file.size > 500 * 1024 * 1024:  # 500MB limit
